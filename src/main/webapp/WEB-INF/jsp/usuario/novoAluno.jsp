...
<form action="<c:url value='/usuario/cadastraAluno'/>" method="post">
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="input-group">
				<span class="input-group-addon glyphicon glyphicon-user"></span> <input
					type="text" class="form-control" id="nome" required name="aluno.nome" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-group">
				<span class="input-group-addon glyphicon glyphicon-tag"></span> <input
					...
					id="matricula" required name="aluno.matricula" />
			</div>
		</div>
	</fieldset>
